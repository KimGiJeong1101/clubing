...
export const registerImages = (clubNumber, newImages) => {
    return axios.post(`http://localhost:4000/clubs/gallery/${clubNumber}/images`, newImages);
  };
...
export const deleteImages = async (clubNumber, { imageIds, writer }) => {
  await axios.delete(`http://localhost:4000/clubs/gallery/${clubNumber}/images`, {
...
export const deleteAllImages = async (clubNumber, { writer }) => {
  await axios.delete(`http://localhost:4000/clubs/gallery/${clubNumber}/images/all`, {
...
export const editImage = async (clubNumber, { id, formData }) => {
  await axios.put(`http://localhost:4000/clubs/gallery/${clubNumber}/images/${id}`, formData);
};
