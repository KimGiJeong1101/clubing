      ...
      <Container maxWidth="lg" sx={{ paddingBottom: "40px" }}>
        ...
        <Box sx={{ mt: 5, padding: "20px" }}>
          <Box sx={{ borderBottom: "3px solid black", mb: 2, pb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Typography variant="body1" sx={{ color: "gray" }} onClick={() => navigate(`/clubList`)}>
              더보기
            </Typography>
          </Box>
        ...
        <Box sx={{ mt: 5, padding: "20px" }}>
          <Box sx={{ borderBottom: "3px solid black", mb: 2, pb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Typography variant="body1" sx={{ color: "gray" }} onClick={() => navigate(`/recommendedClubList`)}>
              더보기
            </Typography>
          </Box>
        ...
        <Box sx={{ mt: 5, padding: "20px" }}>
          <Box sx={{ borderBottom: "3px solid black", mb: 2, pb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Typography variant="body1" sx={{ color: "gray" }} onClick={() => navigate(`/meetingList`)}>
              더보기
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ mt: 5, padding: "20px" }}>
          <Box sx={{ borderBottom: "3px solid black", mb: 2, pb: 1, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Typography variant="body1" sx={{ color: "gray" }} onClick={() => navigate(`/event`)}>
              더보기
            </Typography>
          </Box>
        </Box>
