...
import wishHeart from "../../../components/club/wishHeart.jsx";
...
useEffect(() => {
  if (getClub.clubs && Array.isArray(getClub.clubs.wishHeart) && user.userData.user.email) {
    setIsFavorite(getClub.clubs.wishHeart.includes(user.userData.user.email));
  }
